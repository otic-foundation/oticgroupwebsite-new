...
const ZohoRegistrationModal = ({ open, onOpenChange }: ZohoRegistrationModalProps) => {
  ...
  useEffect(() => {
    if (open && formRef.current) {
      ...
      analyticsScript.src = 'https://crm.zohopublic.com/crm/WebFormAnalyticsServeServlet?rid=&tw=5de8a16a29aac6a0c3b4b05e868fbe931989a71ae77fdbb9c14d8002232dbe0a';
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto bg-background border-border">
        ...
        <div ref={formRef} className="rounded-lg overflow-hidden" />
      </DialogContent>
    </Dialog>
  );
};
